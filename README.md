...
MATLAB code and experiment records for robust, sparse, and smooth PCA in face reconstruction and recognition.
...
Open the repository directory in MATLAB and review the parameter grids in [main.m](main.m) before running `main`. Its default is ORL; [data/](data/) contains AR, FEI, Feret, GT, ORL, and Yale matrices. The script reruns reconstruction and classification sweeps and writes outputs under `result/`. The existing figures below are the original experiment record.
...
- [main.m](main.m): ordered experiment stages and parameter sweeps.
- [RSSPCA.m](RSSPCA.m): algorithm.
- [data/](data/) and [images/](images/): matrices and existing figures.
- [reco_analysis.m](reco_analysis.m) and [classify_analysis.m](classify_analysis.m): result analysis.
